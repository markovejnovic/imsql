...
constexpr InputText::InputText(RenderCtx& renderCtx, const char* label, std::string& value,
  ...
  ImGui::InputText(label, value.data(), value.capacity(), ImGuiInputTextFlags_CallbackResize,
                   +callback, static_cast<void*>(&value));
}
